            ...
            <div className={styles.savedCards}>
              <div className={styles.card}>
                ...
                <div className={styles.cardInfo}>
                  <span>Axim Bank</span>
                  <span className={styles.cardNumber}>**** **** **** 4578</span>
                </div>
              ...
              <div className={styles.card}>
                ...
                <div className={styles.cardInfo}>
                  <span>HDFC Bank</span>
                  <span className={styles.cardNumber}>**** **** **** 4521</span>
                </div>
        ...
        <div className={styles.orderSummary}>
          ...
          <div className={styles.product}>
            ...
            <div className={styles.productInfo}>
              ...
              <ProductPrice price="1,244" offPrice="1,500" offPercentage="10" />
            </div>
            <ion-icon name="trash-outline" className={styles.close}></ion-icon>
          </div>
          ...
          <Button bgColor="#019e43" color="#fff" size="sm">
            Pay Now
          </Button>
        </div>
      </div>
